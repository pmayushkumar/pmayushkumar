...
- [**Customer Research Swarm**](https://github.com/pmayushkumar/customer-research-swarm) — Multi-agent system that turns weeks of customer transcripts into a critiqued, OKR-aligned strategy deck in 15 minutes. Built for a mid-market tech firm with strict on-prem privacy: n8n orchestration, Opus 4.7 + Sonnet 4.6 swarm, Presidio PII scrubbing, Chroma vector store, and a write-back memory loop so the swarm compounds intelligence month over month.
